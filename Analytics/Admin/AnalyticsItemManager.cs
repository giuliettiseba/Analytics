...
namespace Analytics.Admin
{
    ...
    /// </summary>
    public class AnalyticsItemManager : ItemManager
    {
        private AnalyticsUserControl _userControl;
        private Guid _kind;

        #region Constructors

        public AnalyticsItemManager(Guid kind) : base()
        {
            _kind = kind;
        }
        ...
        {
            _userControl = new AnalyticsUserControl();
        ...
        {
            return new AnalyticsAddUserControl();
        }
        ...
        public override bool ValidateAndSaveUserControl()
        {
            if (CurrentItem != null)
            {
                ...
                Configuration.Instance.SaveItemConfiguration(AnalyticsDefinition.AnalyticsPluginId, CurrentItem);
            }
            return true;
        }
        ...
        {
            CurrentItem = new Item(suggestedFQID, ((AnalyticsAddUserControl)addUserControl).ItemName);
            Configuration.Instance.SaveItemConfiguration(AnalyticsDefinition.AnalyticsPluginId, CurrentItem);
            return CurrentItem;
        }
        ...
        public override void DeleteItem(Item item)
        {
            if (item != null)
            {
                Configuration.Instance.DeleteItemConfiguration(AnalyticsDefinition.AnalyticsPluginId, item);
            }
        ...
        public override List<Item> GetItems()
        {
            ...
            List<Item> items = Configuration.Instance.GetItemConfigurations(AnalyticsDefinition.AnalyticsPluginId, null, _kind);
            return items;
        }
        ...
        {
            List<Item> items = Configuration.Instance.GetItemConfigurations(AnalyticsDefinition.AnalyticsPluginId, parentItem, _kind);
            return items;
        }
        ...
        {
            Item item = Configuration.Instance.GetItemConfiguration(AnalyticsDefinition.AnalyticsPluginId, _kind, fqid.ObjectId);
            return item;
        }
