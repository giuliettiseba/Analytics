...
namespace Analytics.Client
{
    ...
    /// </summary>
    public class AnalyticsViewItemManager : ViewItemManager
    {
        private Guid _someid;
        private string _someName;
        private List<Item> _configItems;

        public AnalyticsViewItemManager() : base("AnalyticsViewItemManager")
        {
        }
        ...
        public override void PropertiesLoaded()
        {
            ...
            _configItems = Configuration.Instance.GetItemConfigurations(AnalyticsDefinition.AnalyticsPluginId, null, AnalyticsDefinition.AnalyticsKind);
        ...
        //{
        //	return new AnalyticsViewItemUserControl(this);
        //}
        ...
        {
            return new AnalyticsViewItemWpfUserControl(this);
        }
        ...
        //{
        //	return new AnalyticsPropertiesUserControl(this);
        //}
        ...
        {
            return new AnalyticsPropertiesWpfUserControl(this);
        }
