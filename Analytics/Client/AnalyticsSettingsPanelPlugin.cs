...
{
    public class AnalyticsSettingsPanelPlugin : SettingsPanelPlugin
    {
        ...
        {
            get { return AnalyticsDefinition.AnalyticsSettingsPanel; }
        }

        /// <summary>
        /// Should return the title of this plug-in. It will be displayed in the Settings panel navigation list.
        /// </summary>
        public override string Title { get { return "Analytics"; } }
        ...
        {
            _userControl = new AnalyticsSettingsPanelControl(this);
            return _userControl;
        }
