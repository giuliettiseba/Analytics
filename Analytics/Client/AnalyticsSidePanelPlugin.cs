...
namespace Analytics.Client
{
    ...
    /// </summary>
    public class AnalyticsSidePanelPlugin : SidePanelPlugin
    {
        /// <summary>
        ...
        //{
        //	return new AnalyticsSidePanelUserControl();
        //}
        ...
        {
            return new AnalyticsSidePanelWpfUserControl();
        }
        ...
        {
            get { return AnalyticsDefinition.AnalyticsSidePanel; }
        }
        ...
        {
            get { return "Analytics Side panel"; }
        }
