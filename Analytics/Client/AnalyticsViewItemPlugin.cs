...
namespace Analytics.Client
{
    ...
    /// </summary>
    public class AnalyticsViewItemPlugin : ViewItemPlugin
    {

        public AnalyticsViewItemPlugin()
        {
        }
        ...
        {
            get { return AnalyticsDefinition.AnalyticsViewItemPlugin; }
        }
        ...
        {
            return new AnalyticsViewItemManager();
        }
